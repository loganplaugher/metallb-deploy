pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/loganplaugher/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('plaughlc-225')   // <---- Change this to match your kubernetes cluster credentials
    }
